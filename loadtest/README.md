...
```
aws ecr get-login-password --region eu-central-1 --profile [PROFILE] | docker login --username AWS --password-stdin alewojci-1152.dkr.ecr.eu-central-1.amazonaws.com
```
...
```
docker tag backend-loadtest:latest alewojci-1152.dkr.ecr.eu-central-1.amazonaws.com/backend-loadtest:latest
```

```
docker push alewojci-1152.dkr.ecr.eu-central-1.amazonaws.com/backend-loadtest:latest
```
